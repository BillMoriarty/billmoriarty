...
Chapter 1.1
> "A VR application may allow a user to place an objedct anywhere in 3D space, with any orientation-a task for which a 2D mouse is inadequate."
...
At the end of this chapter tshe authors arrive at this definition:
